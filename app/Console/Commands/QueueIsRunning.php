...
class QueueIsRunning extends Command
{
     /**
    ...
    public function handle()
    {
        ...
        // $command = 'C:\wamp64\bin\php\php7.3.1\php.exe ' . base_path() . '\artisan queue:work --timeout=60 --sleep=5 --tries=3 > NUL 2& echo $!'; // 5.6 - see comments
        // $pid = exec($command);
        // $this->info($pid);
