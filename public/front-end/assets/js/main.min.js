! function (e) {
    ...
    var t = {
        ...
        mobile: !1,
        init: function () {
            this.initialised || (this.initialised = !0, this.checkMobile(), this.stickyHeader(), this.headerSearchToggle(), this.mMenuIcons(), this.mMenuToggle(), this.mobileMenu(), this.scrollToTop(), this.toggleSidebar(), this.sideMenu(), e.fn.superfish && this.menuInit(), e.fn.owlCarousel && this.owlCarousels(), e.fn.themeSticky && this.stickySidebar(), e.fn.Morphext && this.wordRotate(), e.fn.isotope && this.isotopes())
        },
